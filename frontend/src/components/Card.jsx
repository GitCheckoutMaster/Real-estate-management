    ...
    return (
        <div className='flex flex-row gap-4'>
            <div name="image" className=''>
                <img src={whiteHouse} className='rounded-2xl h-64 w-80' alt="" />
            </div>
            <div name="details" className='flex flex-col'>
                <span name="title" className='text-4xl'>The White House</span>
                <div name="location" className='flex flex-row gap-2 items-center'>
                    <img src={location} className='h-4 w-4' alt="" />
                    <span name="address" className='tracking-wider text-lg opacity-60'>1600 Pennsylvania Avenue N.W. in Washington, D.C</span>
                </div>
                <span name="price" className='bg-green-300 text-center max-w-32 text-3xl mt-5 rounded-md'>$100</span>
                <div name="additionalInfo" className='flex flex-row gap-5 mt-5'>
                    <div name="bedrooms" className='text-black flex flex-row bg-gray-300 rounded-lg px-1.5 items-center gap-2'>
                        ...
                        <span className='text-lg font-light tracking-wide opacity-60'>2 Bedroom</span>
                    </div>
                    <div name="bedrooms" className='text-black flex flex-row bg-gray-300 rounded-lg px-1.5 items-center gap-2'>
                        <img src={bathroom} className='h-4 w-4' alt="" />
                        <span className='text-lg font-light tracking-wide opacity-60'>4 Bathroom</span>
                    </div>
                </div>
