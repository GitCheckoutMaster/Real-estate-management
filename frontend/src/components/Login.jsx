                ...
                <div className='w-full bg-white rounded-lg dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700'>
                    <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
                        ...
                        <form className='space-y-4 md:space-y-6' onSubmit={handleSubmit(loginUser)}>
                            ...
                            <button type="submit" className='bg-blue-400 text-xl rounded-lg w-full p-2.5 hover:tracking-widest hover:font-semibold hover:duration-500 duration-500 '>Sign in</button>
